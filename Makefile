...
# opentlc.com/argocd-namespace-operator-bundle:$VERSION and opentlc.com/argocd-namespace-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= opentlc.com/argocd-namespace-operator
